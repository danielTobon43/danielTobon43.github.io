...
<form action="https://formspree.io/xrgyvdbz" method="POST" class="form" id="contact-form">
  ...
  <div class="row">
    <div class="col-xs-6">
      <input type="email" name="_replyto" required="required" class="form-control input-lg" placeholder="Email" title="Email" style="margin: 0px 0px 10px 17px;">
    </div>
    <div class="col-xs-6">
      <input type="text" name="name" class="form-control input-lg" placeholder="Name" title="Name" style="margin: 0px 0px 10px 10px;">
    </div>
  </div>
